...
### Agent Roster
- **Architect** — structural analysis, task breakdown, acceptance review (spawned for planning, always). SOUL: `references/multi-agent-mode/souls/architect.md`
- **Coder** — claims tasks, implements, self-verifies (one per task, spawned sequentially). SOUL: `references/multi-agent-mode/souls/coder.md`
- **Tester** — verifies changes with evidence, challenges Coder and Architect (on-demand). SOUL: `references/multi-agent-mode/souls/tester.md`
- **Researcher** — finds docs, evaluates source trustworthiness (on-demand). SOUL: `references/multi-agent-mode/souls/researcher.md`
- **Retrospective Agent** — post-run pattern analysis, proposes system improvements (on-demand, one-shot). SOUL: `references/multi-agent-mode/souls/retrospective.md`
